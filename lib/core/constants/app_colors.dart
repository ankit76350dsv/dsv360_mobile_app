...
class AppColorsDark {
  ...
  // tab-bar
  static const Color tabbarBackground = Color(0xFF242424);
  static const Color tabbarIndicator = Color(0xFF0F0F0F);
...
class AppColorsLight {
  ...
  // tab-bar
  static const Color tabbarBackground = Color(0xFFE6EBE6);
  static const Color tabbarIndicator = Colors.white;
